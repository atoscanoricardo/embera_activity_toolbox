  ...
  <v-container grid-list-md>
    <v-card max-width="500" class="mx-auto">
      ...
      <v-card-text>
        ...
        <p class="font-weight-regular">Seleccione los saludos Embera</p>
        <v-card class="mx-auto" max-width="500">
          <img
            :src="require('../assets/saludos_act1.jpeg')"
            width="340"
            :aspect-ratio="16 / 9"
          />
          <v-select
      ...
      <v-card-text>
        ...
        <p class="font-weight-regular">
          Seleccione el Saludos Embera para cada imágen
        </p>
